/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9cce7fd9db882b8e2a3efdd95e7c3d08)
// Runtime types generated with workerd@1.20250525.0 2025-06-05 
declare namespace Cloudflare {
	interface Env {
		JWKS: "https://xegknevgslsjbiezyzxv.supabase.co/auth/v1/keys";
		REMINDER_QUEUE: DurableObjectNamespace<import("./src/index").ReminderQueue>;
		AI: Ai;
	}
}
